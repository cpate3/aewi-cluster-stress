// This GO code is calling to stress utility for evaluating kubernetes cluster and its nodes performance 
package main
...
// Common variables.
var (
	description = "Stress checker for Kubernetes nodes."
	gitCommit   = "n/a"
	name        = "aewi-cluster-stress"
	source      = "https://github.com/cpate3/aewi-cluster-stress"
)
...
func main() {
	...
	// FOR loop to invoke stress command multiple times (This stress iterations within pods)
